  ...
  return (
    <div className={styles.bookstoreContainer}>
     ...
     <HeroBanner />
      ...
      <BooksSection books={featuredBooks} renderStars={renderStars} text={"Ver todos"} title={"Destaques da semana"} viewAllLink={"/destaques"}/>

      {/* CATEGORIES SECTION */}
    <Categories categories={categories} />

      {/* NEW RELEASES SECTION */}
      <BooksSection books={featuredBooks} renderStars={renderStars} text={"Ver todos"} title={"Lançamentos"} viewAllLink={"/lancamentos"}/>
